...
ActiveRecord::Schema.define(:version => 20110411210539) do
  ...
  add_index "relationships", ["user1_id", "user2_id", "is_followed"], :name => "index_relationships_on_user1_id_and_user2_id_and_is_followed"
  add_index "relationships", ["user1_id", "user2_id", "is_follower"], :name => "index_relationships_on_user1_id_and_user2_id_and_is_follower"
  add_index "relationships", ["user1_id", "user2_id"], :name => "index_relationships_on_user1_id_and_user2_id"
  ...
  create_table "users", :force => true do |t|
    ...
    t.timestamp "background_image_updated_at"
    t.integer   "posts_count",                                  :default => 0
    t.boolean   "is_host"
    t.integer   "post_id"
  ...
  add_index "users", ["id", "username", "full_name", "photo_id"], :name => "index_users_on_id_and_username_and_full_name_and_photo_id"
